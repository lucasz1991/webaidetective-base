...
>
    ...
    <x-profile.detail-hero id="profil">
        ...
        <x-slot:badges>
            ...
            <livewire:user.tracked-person-scan-overview
                :tracked-person-id="$trackedPerson->id"
                :detail-status="$detailStatus"
                :detail-status-level="$detailStatusLevel"
                :key="'tracked-person-scan-overview-'.$trackedPerson->id"
            />
    ...
    <section
        ...
        x-init="
            if (@js($detailDefaultTab) === 'karte' && !networkMapRequested) {
                networkMapRequested = true;
                $wire.loadNetworkMap();
            }
        "
        x-on:ui-tab-selected="
            if ($event.detail.tab === 'karte' && !networkMapRequested) {
                networkMapRequested = true;
                $wire.loadNetworkMap();
            }
        "
